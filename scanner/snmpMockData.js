/** Deterministic mock port data for dev when Net-SNMP is unavailable. */
...
export const MOCK_SWITCH_PORT_DATA = {
  "192.168.10.2": {
    ...
    ports: [
      ...
      { port: 7, ifAlias: "QSys-Core", macAddr: "00:1A:4B:77:88:99", connectedDevice: "Q-SYS Core", ifOperStatus: "up", ifSpeed: 1000, vlan: 40, poeWatts: null },
      { port: 8, ifAlias: "NAS-Synology", macAddr: "00:1B:8F:11:22:33", connectedDevice: "NAS-Main", ifOperStatus: "up", ifSpeed: 1000, vlan: 1, poeWatts: null },
    ],
  },
  "192.168.10.3": {
    name: "SW-Saloon",
    ...
    ports: [
      ...
      { port: 3, ifAlias: "PoE-Cam-Saloon", macAddr: "3C:EF:8C:DD:EE:FF", connectedDevice: "Cam-Saloon-01", ifOperStatus: "up", ifSpeed: 100, vlan: 30, poeWatts: 6.1 },
      { port: 4, ifAlias: "", macAddr: null, connectedDevice: null, ifOperStatus: "down", ifSpeed: 1000, vlan: 1, poeWatts: null },
    ],
  },
};
