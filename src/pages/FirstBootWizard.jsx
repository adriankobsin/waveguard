...
import {
  ...
  Network, Camera, Monitor, Zap, Server, Loader2, Globe, QrCode
} from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-muted-foreground">Guardian AI found the following subnets on this vessel's network.</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-muted-foreground">This information helps Guardian AI personalise alerts and reports.</p>
      </div>
...
function Step4Done({ vesselName }) {
  ...
  return (
    <div className="space-y-6 text-center">
      ...
      <div>
        <h2 className="text-xl font-bold text-foreground">Guardian AI is Ready</h2>
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-muted-foreground mt-1">Wave-AVI Appliance Setup</p>
        </div>
