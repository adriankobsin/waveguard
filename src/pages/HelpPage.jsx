...
const USAGE_SECTIONS = [
  {
    ...
    steps: [
      {
        label: "What is Guardian AI?",
        body: `Guardian AI is an enterprise AV & network management platform designed for superyachts, large vessels, commercial facilities, and marine environments. It centralises:
    ...
    steps: [
      {
        ...
        body: `• Place the Guardian AI server on a dedicated Management VLAN
...
# Check you can see the Guardian AI login page
...
7. Find your Network ID from the organization response`
      ...
      {
        label: "Step 4 — Add to Guardian AI Settings",
        body: `1. Open Guardian AI → Settings → Integrations → Cisco
2. Enter:
...
Document these — you'll need them to map controls in Guardian AI.`
      },
      {
...
3. Map join numbers to Guardian AI control labels:
...
# Map zone IDs to your Guardian AI Lighting zones in:
# Settings → Integrations → Lutron → Zone Mapping`
      },
      {
        label: "Step 4 — Configure in Guardian AI",
...
>V:2,C:13,G:1@`
      ...
      {
        label: "Step 4 — Add to Guardian AI",
...
6. Assign groups to Guardian AI Lighting zones
...
3. USB-to-DMX with OLA server
   Connect Enttec Open DMX USB to Guardian AI server
...
DMX_ARTNET_UNIVERSE=0`
      },
      {
        ...
        body: `# On the Guardian AI server:
...
5. Import this CSV in Guardian AI → Settings → KNX → Import GA List`
      },
      {
...
3. Enter the individual address for the Guardian AI client (e.g. 1.1.255)
4. Click Import Group Addresses — upload your ETS CSV export
5. Each GA appears in a list — assign to Guardian AI zones/controls:
          ...
          <div className="rounded-xl border border-white/8 overflow-hidden">
            ...
            <div className="px-5 py-5 space-y-6">
              ...
              <div className="flex items-start gap-2 p-3 bg-emerald-500/8 border border-emerald-500/20 rounded-lg">
                ...
                <p className="text-xs text-emerald-200">After completing all 11 steps, Guardian AI is fully operational on your local network with auto-start on boot, HTTPS, and local DNS access.</p>
              </div>
            </div>
          </div>
        )}
